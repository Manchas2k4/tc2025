/**
	This program hides a text message inside an image, 
	using a steganography technique. It receives the name 
	of a BMP file and a file containing the text to be 
	hidden.
